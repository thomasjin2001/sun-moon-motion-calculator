#Final Project: The Sun and the Moon Apparent Motion Calculator
#Author: Thomas Jin
#Date: 12/2023
...
while choice == '1':
    try:
        ...
        filename = input('Please enter the pathname where you can save your text results (TXT file only):\n>>')
        ...
        try:
            with open(filename, 'w') as file:
                file.write(result1 + '\n' + result2)
            print('*The text results above have been written to the TXT file successfully!')
        except IsADirectoryError:
            print('***The path entered is a directory, not a file. Please enter a valid file path ending with ".txt".***')
